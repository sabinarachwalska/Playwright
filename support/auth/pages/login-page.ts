...
export class LoginPage extends BasePage {
    ...
    public readonly signUpLoginButton : Locator = this.page.locator('a[href="/login"]')
    ...
    public readonly loggedUserText: Locator = this.page.getByText(' Logged in as ')
    public readonly deleteAccountButton: Locator = this.page.locator('a[href="/delete_account"]')
    ...
    public async clickLoginSignUpButton(){
        return waitForResponse(this.page.waitForRequest('/login'), () => this.signUpLoginButton.click())
    }
    ...
    public async clickSignUpButton(){
        return waitForResponse(this.page.waitForRequest('/signup'), () => this.signUpButton.click())
    }
    ...
    public async clickDeleteAccount(){
        return waitForResponse(this.page.waitForRequest('/delete_account'), () => this.deleteAccountButton.click())
    }

    public async clickLoginButton(){
        return waitForResponse(this.page.waitForRequest('/login'), () => this.loginButton.click())
    }

    public async logInToTheAccount(name:string, password:string){
