...
type ExtractWorkerArgs<T> =
  T extends TestType<any, infer TArgs> ? TArgs : never;
...
> = TestType<
  ExtractTestArgs<TBaseTestType> & TTestArgs,
  ExtractWorkerArgs<TBaseTestType> & TWorkerArgs
>;
